...
<tr>
<td id="esrs_field" class="esrs_field">{$_find.menu_campuses}</td>
<td id="esrs_field" class="esrs_field">{$_find.menu_buildings}</td>
<td id="esrs_field" class="esrs_field"><input id="esrs_text" class="esrs_text" type=text name="esrs_find[room_number]" maxlength=10 size=10 value="{$_find.room_number}"></td>
...
<td id="esrs_label" class="esrs_label">Building &nbsp;<a href="javascript:" onClick="esrs_set('esrs_find','sortorder','b_u');"><img src="http://{$host_url}/img/arrw_up.jpg" border=0></a><a href="javascript:" onClick="esrs_set('esrs_find','sortorder','b_d');"><img src="http://{$host_url}/img/arrw_dwn.jpg" border=0></a></td>
<td id="esrs_label" class="esrs_label" width=160>(toggle) Room Number &nbsp;<a href="javascript:" onClick="esrs_set('esrs_find','sortorder','r_u');"><img src="http://{$host_url}/img/arrw_up.jpg" border=0></a><a href="javascript:" onClick="esrs_set('esrs_find','sortorder','r_d');"><img src="http://{$host_url}/img/arrw_dwn.jpg" border=0></a></td>
<td id="esrs_label" class="esrs_label">Name &nbsp;<a href="javascript:" onClick="esrs_set('esrs_find','sortorder','n_u');"><img src="http://{$host_url}/img/arrw_up.jpg" border=0></a><a href="javascript:" onClick="esrs_set('esrs_find','sortorder','n_d');"><img src="http://{$host_url}/img/arrw_dwn.jpg" border=0></a></td>
