<form name="signin" method="POST" action="http://{$host_url}/">
...
<p>
<div id="esrs_fail" class="esrs_fail">{$login_fail}</div>
<div id="esrs_pass" class="esrs_pass">{$login_pass}</div>
</p>

<table border=0 cellpadding=0 cellspacing=4>
<tr><td id="esrs_label" class="esrs_label">Username</td></tr>
<tr><td id="esrs_field" class="esrs_field"><input class="esrs_text" type=text name="username" maxlength=40 size=20 value="{$_fields.username}"></td></tr>
